...
sed -i "9i uci set network.wan.ifname='eth0'" ./package/lean/default-settings/files/zzz-default-settings  # 网络端口
sed -i "10i uci set network.wan.netmask='255.255.255.0'" ./package/lean/default-settings/files/zzz-default-settings    # 子网掩码
sed -i "11i uci set network.wan.gateway='192.168.0.1'" ./package/lean/default-settings/files/zzz-default-settings  # 默认网关地址
sed -i "12i uci set network.wan.dns='192.168.0.253'" ./package/lean/default-settings/files/zzz-default-settings  # 默认上游 DNS 地址
